  ...
  return (
    <div className={locationClasses}>
      <label className="swap swap-rotate">
        ...
        <svg
          className={
            "swap-on fill-current text-primary transition-all duration-500 hover:text-secondary" +
            svgClasses
          }
        ...
        <svg
          className={
            "swap-off fill-current text-primary transition-all duration-500 hover:text-secondary" +
            svgClasses
          }
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
